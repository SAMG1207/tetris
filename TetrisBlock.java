...
public class TetrisBlock {
    ...
    private Color[] availableColors = {Color.BLUE, Color.GREEN, Color.ORANGE, Color.YELLOW, Color.RED};
    ...
    public void spawn(int gridWidth){
       ...
       //Se hace antes poque la altura y el ancho dependen de la forma del bloque
       y = -getHeight();
